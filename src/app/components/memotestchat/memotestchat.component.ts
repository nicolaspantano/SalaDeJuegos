...
import { MemotestchatService } from 'src/app/services/memotestchat.service';
@Component({
  selector: 'app-memotestchat',
  templateUrl: './memotestchat.component.html',
  styleUrls: ['./memotestchat.component.css']
})
export class MemotestchatComponent implements OnInit {
  ...
  constructor(private mensajeSvc:MemotestchatService,private router:Router) {
